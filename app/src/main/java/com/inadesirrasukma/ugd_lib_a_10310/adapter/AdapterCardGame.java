...
import com.inadesirrasukma.ugd_lib_a_10310.databinding.AdapterCardGameBinding;
...
public class AdapterCardGame extends RecyclerView.Adapter<AdapterCardGame.CardGameViewHolder> implements Filterable {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if(charSequence == null || charSequence.length() == 0) {
                    ...
                    filterResults.values = listData.stream().filter(data ->
