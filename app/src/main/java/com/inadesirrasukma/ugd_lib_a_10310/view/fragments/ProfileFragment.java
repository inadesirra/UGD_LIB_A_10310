...
import com.inadesirrasukma.ugd_lib_a_10310.databinding.FragmentProfileBinding;
import com.inadesirrasukma.ugd_lib_a_10310.view.MainViewModel;
import com.inadesirrasukma.ugd_lib_a_10310.view.QRScannerActivity;
                        ...
                        public void onActivityResult(ActivityResult result) {
                            if (result.getResultCode() == Activity.RESULT_OK) {
                                try {
                                    ...
                                    String strQR = intent.getStringExtra("QR_RESULT");
                                    viewModel.scanQRUserProfile(strQR);
                                } catch (Exception e) {
